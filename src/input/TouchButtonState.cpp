...
constexpr TouchButtonResult pressCandidate =
    updateTouchButton(initialState, true, 100, 60, 300);
...
constexpr TouchButtonResult pressTooSoon =
    updateTouchButton(pressCandidate.state, true, 159, 60, 300);
...
constexpr TouchButtonResult pressed =
    updateTouchButton(pressTooSoon.state, true, 160, 60, 300);
...
constexpr TouchButtonResult held =
    updateTouchButton(pressed.state, true, 1000, 60, 300);
...
constexpr TouchButtonResult releaseCandidate =
    updateTouchButton(held.state, false, 1100, 60, 300);
constexpr TouchButtonResult releaseTooSoon =
    updateTouchButton(releaseCandidate.state, false, 1399, 60, 300);
...
constexpr TouchButtonResult released =
    updateTouchButton(releaseTooSoon.state, false, 1400, 60, 300);
...
constexpr TouchButtonResult secondPressCandidate =
    updateTouchButton(released.state, true, 1500, 60, 300);
constexpr TouchButtonResult secondPress =
    updateTouchButton(secondPressCandidate.state, true, 1560, 60, 300);
